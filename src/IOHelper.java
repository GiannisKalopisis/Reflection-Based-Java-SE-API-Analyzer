...
/**
 * IOHelper - A utility class for input and output operations.
 * <p>
 * This class provides methods for printing messages, displaying top N polymorphic types and overloaded methods
 * to the terminal, and printing top N methods from a map of MethodInfo objects.
 */
public class IOHelper {
     ...
     *
     * @param topN                          The number of top overloaded methods to print. A value of 0 prints all methods.
     * @param overloadDegreeMapByMethodName A map of method names and their associated MethodInfo objects and overload degrees.
     */
    public static void printTopNMethods(int topN, Map<String, Map<MethodInfo, Integer>> overloadDegreeMapByMethodName) {
        // Flatten the map into a list of MethodInfo-Integer pairs
